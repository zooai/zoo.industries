...
const ecosystemPoints = [
  ...
  {
    h: '$AI is mineable',
    p: 'Run a node, contribute inference, mine $AI. $ZOO is the fixed-supply governance token; $AI is the compute-meter token, both live on Zoo Network with a regulated bridge via a regulated partner.',
