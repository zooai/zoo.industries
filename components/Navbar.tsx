...
const navMenus: Record<string, MenuConfig> = {
  research: {
    ...
    items: [
      ...
      { label: 'Open Source', href: '/open-source', description: '700+ repos, revenue sharing', icon: Github },
      { label: 'Blog', href: '/blog', description: 'Articles and updates', icon: FileText },
      { label: 'News', href: '/news', description: 'Latest from Zoo', icon: FileText },
      { label: 'Case Studies', href: '/case-studies', description: 'Real-world implementations', icon: Microscope },
      { label: 'Press', href: '/press', description: 'Media and announcements', icon: FileText },
      { label: 'Papers', href: 'https://papers.zoo.ngo', description: '130+ research papers', icon: FileText, external: true },
    ],
  },
  solutions: {
    title: 'Solutions',
    items: [
      { label: 'Overview', href: '/solutions', description: 'How Zoo helps', icon: Sparkles },
      { label: 'Capabilities', href: '/capabilities', description: 'What we offer', icon: Zap },
      { label: 'Decentralized AI', href: '/capabilities/decentralized-ai', description: 'DeAI capability', icon: Network },
      { label: 'Services', href: '/services', description: 'Professional services', icon: Server },
      { label: 'Cloud', href: '/cloud', description: 'Zoo Cloud platform', icon: Cloud },
      { label: 'Intelligence', href: '/intelligence', description: 'AI agents and copilots', icon: Brain },
      { label: 'Cybersecurity', href: '/cybersecurity', description: 'Security solutions', icon: Shield },
      { label: 'Defense', href: '/defense', description: 'Defense use cases', icon: Shield },
      { label: 'Security', href: '/security', description: 'Platform security', icon: Shield },
    ],
  },
  models: {
    title: 'Models',
    items: [
      { label: 'All Zen Models', href: '/models', description: '600M–1T+ parameter models', icon: Sparkles },
      { label: 'AI Models', href: '/ai-models', description: 'Full model catalog', icon: Brain },
      { label: 'Examples', href: '/examples', description: 'Sample projects', icon: Code2 },
      { label: 'Model API', href: site.links.modelApi, description: 'API access and pricing', icon: Cpu, external: true },
      { label: 'Hugging Face', href: site.links.huggingFace, description: 'Download model weights', icon: Bot, external: true },
    ],
  },
  developers: {
    title: 'Developers',
    items: [
      { label: 'Docs', href: '/docs', description: 'Technical guides', icon: BookOpen },
      { label: 'API Reference', href: '/docs/api', description: 'API documentation', icon: Code2 },
      { label: 'SDK', href: '/docs/sdk', description: 'Client libraries', icon: Code2 },
      { label: 'Install', href: '/install', description: 'Get started', icon: Zap },
      { label: 'Examples', href: '/examples', description: 'Sample projects and code', icon: Microscope },
  ...
  products: {
    ...
    items: [
      ...
      { label: 'Pricing', href: '/pricing', description: 'Plans and pricing', icon: FileText },
    ],
  },
  company: {
    title: 'Company',
    items: [
      { label: 'About', href: '/about', description: 'Our mission and values', icon: Sparkles },
      { label: 'Team', href: '/team', description: 'Leadership and AI workforce', icon: Boxes },
      { label: 'Careers', href: '/careers', description: 'Join us', icon: Zap },
      { label: 'Press', href: '/press', description: 'News and media coverage', icon: FileText },
      { label: 'Contact', href: '/contact', description: 'Get in touch', icon: MessageSquare },
      { label: 'Help', href: '/help', description: 'Support and FAQ', icon: BookOpen },
      { label: 'Status', href: '/status', description: 'System status', icon: Network },
      { label: 'Privacy', href: '/privacy', description: 'Privacy policy', icon: Shield },
      { label: 'Terms', href: '/terms', description: 'Terms of service', icon: FileText },
    ],
  },
}
