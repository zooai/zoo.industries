      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            ...
            <div className="backdrop-blur-xl border rounded-2xl shadow-2xl overflow-hidden bg-white dark:bg-zinc-900 border-border shadow-background/50">
              {/* Zen AI Models */}
              <div className="p-4">
    ...
    >
      ...
      <AnimatePresence>
        {isOpen && (
          ...
          >
            <div aria-hidden className="h-5" />
            <div className="backdrop-blur-xl border rounded-xl shadow-2xl overflow-hidden bg-white dark:bg-zinc-900 border-border shadow-background/50">
              <div className="py-2">
                {menu.items.map((item) => {
      ...
      <AnimatePresence>
        {isMobileMenuOpen && (
          <motion.div
            ...
            className="absolute top-full left-0 right-0 md:hidden backdrop-blur-xl border-t rounded-b-2xl overflow-hidden bg-white dark:bg-zinc-900 border-border"
          >
