        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 md:gap-8 mb-6 md:mb-8">
          <motion.div {...fade} transition={{ duration: 0.5 }} className="panel lg:col-span-2 space-y-4">
            <p className="text-base md:text-lg font-medium">
              Through liquidity.io, ZOO gains a compliant path to tokenize and
      ...
      <Section id="how">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-4 md:gap-5">
          {[
            ...
            "Exchange your $AI or $ZOO coins for any other cryptocurrency, and up to 13,000+ digital securities via our regulated ATS partner, Liquidity.io.",
          ].map((step, i) => (
            <motion.div
              key={i}
              {...fade}
